...
namespace Local
{
	...
	GrowingArray<DefaultAction> GetDefaultInputMapping(InputHandler& inputHandler)
	{
		...
		{ eInputAction::PlayerMoveJoystick, (uint8)InputActionMap::eInputType::Direction, (uint8)InputActionMap::eDirectionInputType::JoystickLeft },
		{ eInputAction::PlayerMoveJoystick, (uint8)InputActionMap::eInputType::Direction, (uint8)InputActionMap::eDirectionInputType::Mouse},
