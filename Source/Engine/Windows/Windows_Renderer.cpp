...
bool VlkRenderer::Init(RESOLUTIONS startupResolution, ShaderManager* shaderManager, TextureManager* textureManager, Timer* timer)
{
	m_timer = timer;
...
VkImageView Hail::VlkRenderer::CreateImageView(VkImage image, VkFormat format)
{
